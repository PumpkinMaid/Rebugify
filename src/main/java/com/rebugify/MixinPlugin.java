...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage) {
        version = FabricLoader.getInstance().getRawGameVersion();
    }
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.equals("com.rebugify.mixin.comparatorDuplicationEnabled.ComparatorBlockMixin")) return version.equals("26.2-snapshot-2");
        if (mixinClassName.equals("com.rebugify.mixin.comparatorDuplicationEnabled.DiodeBlockMixin")) return version.equals("26.2-snapshot-2");
