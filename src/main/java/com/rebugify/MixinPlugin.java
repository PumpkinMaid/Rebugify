...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.equals("com.rebugify.mixin.comparatorDuplicationEnabled.ComparatorBlockMixin")) return version.equals("26.2-snapshot-");
        if (mixinClassName.equals("com.rebugify.mixin.comparatorDuplicationEnabled.DiodeBlockMixin")) return version.equals("26.2-snapshot-");
